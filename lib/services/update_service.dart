...
import 'package:open_filex/open_filex.dart' if (kIsWeb) '';
...
class UpdateService {
  ...
  /// Downloads the APK and opens the Android installer.
  /// Returns true on success, false on failure.
  /// [onProgress] receives values from 0.0 to 1.0 during download.
